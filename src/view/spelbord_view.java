...
public class spelbord_view {
	...
	public Stage spelbord_show() {
		...
		MolKnop[] buttonArray = new MolKnop[61];
		...
		for (int column = 19; column < 29; column = column + 2) {
			MolKnop veld = new MolKnop(((column + 1) / 2 - 10) , (10 - ((column + 1) / 2)), -4);
		...
		buttonArray[0].setCoordinaten(4, 0, -4);
